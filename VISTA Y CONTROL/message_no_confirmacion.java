 ...
 * @author JOSE
 */
public class message_no_confirmacion extends javax.swing.JFrame {

    /**
     * Creates new form message_no_confirmacion
     */
    public message_no_confirmacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Debe aceptar el uso de datos personales");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(message_no_confirmacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new message_no_confirmacion().setVisible(true);
            }
        });
    }
