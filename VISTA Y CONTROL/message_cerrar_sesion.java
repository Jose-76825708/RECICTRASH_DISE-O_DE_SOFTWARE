...
public class message_cerrar_sesion extends javax.swing.JFrame {

    /**
     * Creates new form message_cerrar_sesion
     */
    public message_cerrar_sesion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(303, 122));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setPreferredSize(new java.awt.Dimension(199, 15));
        ...
        jLabel2.setText("¿Estas seguro de cerrar sesión?");

        jPanel3.setBackground(new java.awt.Color(33, 143, 104));
        jPanel3.setPreferredSize(new java.awt.Dimension(119, 28));
        ...
        jPanel11.setPreferredSize(new java.awt.Dimension(119, 28));
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        dispose();
        screen_login volvemos = new screen_login();
        volvemos.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(message_cerrar_sesion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new message_cerrar_sesion().setVisible(true);
            }
        });
    }
