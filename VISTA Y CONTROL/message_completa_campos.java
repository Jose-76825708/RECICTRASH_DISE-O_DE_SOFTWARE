 ...
 * @author JOSE
 */
public class message_completa_campos extends javax.swing.JFrame {

    /**
     * Creates new form message_completa_campos
     */
    public message_completa_campos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Complete todos los campos que se requieren");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(message_completa_campos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new message_completa_campos().setVisible(true);
            }
        });
    }
