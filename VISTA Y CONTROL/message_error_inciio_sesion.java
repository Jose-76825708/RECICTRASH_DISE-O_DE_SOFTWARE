 ...
 * @author JOSE
 */
public class message_error_inciio_sesion extends javax.swing.JFrame {

    /**
     * Creates new form message_no_confirmacion
     */
    public message_error_inciio_sesion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El correo o la contraseña son incorrectos");

        jPanel4.setBackground(new java.awt.Color(33, 143, 104));
        jPanel4.setPreferredSize(new java.awt.Dimension(119, 28));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(message_error_inciio_sesion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new message_error_inciio_sesion().setVisible(true);
            }
        });
    }
